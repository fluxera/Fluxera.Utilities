...
namespace Fluxera.Utilities.Extensions
{
	...
	public static partial class ListExtensions
	{
		...
		public static void AddRange<T>(this IList<T> target, IEnumerable<T> values)
		{
		...
		/// <summary>
		///     Adds the given values to the target list if the element to add matches
		///     the given predicate.
		/// </summary>
		/// <typeparam name="T">The type of the elements.</typeparam>
		/// <param name="target">The target list to add the elements to.</param>
		...
		public static void AddRangeFor<T>(this IList<T> target, IEnumerable<T> values, Predicate<T> predicate)
		{
			Guard.Against.Null(target, nameof(target));
			Guard.Against.Null(values, nameof(values));
